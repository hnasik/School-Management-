...
function printPDF(d) {
  ...
  <body>
    ...
    <table>
      ...
      <tr><td>Class</td><td>${d.studentClass || ""}</td></tr>
      <tr><td>AdmissionFee</td><td>${d.admissionFee || ""}</td></tr>
      <tr><td>Age</td><td>${d.age || ""}</td></tr>
      <tr><td>DOB</td><td>${d.dob || ""}</td></tr>
      <tr><td>Due Amount</td><td>${d.dueFee || ""}</td></tr>
       <tr><td>Monthly Amount</td><td>${d.monthlyFee|| ""}</td></tr>
      <tr><td>Academic Year</td><td>${d.academicYear|| ""}</td></tr>
  <tr><td>Mobile No</td><td>${d.mobile|| ""}</td></tr>
